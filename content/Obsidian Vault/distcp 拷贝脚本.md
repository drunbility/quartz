...
runningnum=20
export HADOOP_USER_NAME=ca_effect
...
logFile="${rootDir}/zhihu_diff${logTime}.log"
...
mv ${rootDir}/zhihu_qy_*.txt ${rootDir}/${dirName}

  

#logInfo "start to distcp for add..."

#sh ${rootDir}/autodistcp.sh ${rootDir}/${dirName}/zhihu_qy_need_to_add_forDistcp.txt 2>&1

  

#logInfo "start to distcp for replace..."

#sh ${rootDir}/autodistcp.sh ${rootDir}/${dirName}/zhihu_qy_need_to_replace_forDistcp.txt 2>&1
